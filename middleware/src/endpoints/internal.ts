...
import { FailedResult, MiddlewareConfig, PostingModeSwitchResult, Wallet } from '../types';
...
export async function userWalletLoginWithoutChecks(): Promise<Wallet | FailedResult> {
...
export async function cardanoWalletLoginEndpoint(): Promise<Wallet | FailedResult> {
