...
import type { GameInputValidatorCore, ErrorCode, ErrorMessageFxn, UserInput } from './types.js';
...
export const GAME_INPUT_VALIDATOR_PERIOD = parseInt(
  process.env.GAME_INPUT_VALIDATOR_PERIOD || '0',
  10
);
export const BATCHED_TRANSACTION_POSTER_PERIOD = parseInt(
  process.env.BATCHED_TRANSACTION_POSTER_PERIOD || '0',
  10
);
export const BATCHED_MESSAGE_SIZE_LIMIT = parseInt(
  process.env.BATCHED_MESSAGE_SIZE_LIMIT || '0',
  10
);

export const MAX_USER_INPUTS_PER_MINUTE = parseInt(
  process.env.MAX_USER_INPUTS_PER_MINUTE || '0',
  10
);
...
export const GAME_INPUT_VALIDATION_TYPE_NAME =
  process.env.GAME_INPUT_VALIDATION_TYPE_NAME || 'no-validation';
export const GAME_INPUT_VALIDATION_TYPE = getGameInputValidatorType(
  GAME_INPUT_VALIDATION_TYPE_NAME
);
